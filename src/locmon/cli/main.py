...
from locmon import __version__
from locmon.infrastructure import get_logger


def setup_cli_logging(config_path: Optional[str]) -> None:
    """Initialize logging from config file."""
    from locmon.infrastructure.logger import setup_logging
    from locmon.infrastructure import Config
...
def monitor(ctx: click.Context, count: Optional[int], filter: Optional[str]) -> None:
    ...
    """
    from locmon.service import NetworkMonitorService as Monitor
    from locmon.infrastructure import Config
...
def export(ctx: click.Context, format: str, output: Optional[str]) -> None:
    ...
    """
    from locmon.infrastructure import create_exporter
